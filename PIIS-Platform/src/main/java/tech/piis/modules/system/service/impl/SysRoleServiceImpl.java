...
import tech.piis.framework.aspectj.lang.annotation.DataScope;
...
import tech.piis.modules.system.domain.SysRoleDept;
import tech.piis.modules.system.domain.SysRoleMenu;
import tech.piis.modules.system.mapper.SysRoleDeptMapper;
import tech.piis.modules.system.mapper.SysRoleMapper;
import tech.piis.modules.system.mapper.SysRoleMenuMapper;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    @Autowired
    private IInspectionAnnouncementInfoService announcementInfoService;
...
//        testInsertAnnouncementInfo();
//        testInsertRole();
        List<PiisDocumentPO> documents = new ArrayList<>();
        documents.add(new PiisDocumentPO().setPiisDocId(1438L));
        announcementInfoService.save(new InspectionAnnouncementInfoPO().setPlanId("1212").setUnitsId(11323L).setDocuments(documents));
        testInsertAnnouncementInfo();
    }

    private void testInsertAnnouncementInfo() {
        SysRole sysRole = new SysRole();
        sysRole.setRoleName("1111");
