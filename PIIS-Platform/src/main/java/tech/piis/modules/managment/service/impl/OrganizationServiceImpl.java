...
import tech.piis.modules.managment.domain.po.*;
import tech.piis.modules.managment.domain.vo.*;
...
//        updateFile(inspectionOfficeId);
        ...
        memberResumePOList.forEach(memberResumePO -> {
            ...
            if (null == memberResumePO1) {
                ...
                BizUtils.setCreatedTimeOperation(MemberResumePO.class, memberResumePO1);
...
//            leadingGroupMemberPO.setPiisDocumentPO(documents);
    ...
    private List<PiisDocumentPO> getDocumentsByObjectId(String leadingGroupId) {
        ...
        List<PiisDocumentPO> documents = documentMapper.selectList(docuWrapper);
        return documents;
    }
